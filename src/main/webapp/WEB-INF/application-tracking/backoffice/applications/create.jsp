...
<c:set var="base" value="${pageContext.request.contextPath}/application-tracking/${period.slug}/applications" scope="request" />
...
<t:applications>
  <jsp:body>
    ...
    <fmt:message key="message.basic.data" />
      <form class="form-horizontal" action="${base}/create" method="POST">
