<%--@elvariable id="requirement" type="org.fenixedu.applicationtracking.domain.Requirement"--%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>

<h1><fmt:message key="label.requirement.edit" /></h1>
<ol class="breadcrumb">
	...
	<li class="active"><fmt:message key="label.requirement.edit" /> - <c:out value="${requirement.name.content}"/></li>
</ol>
<h3><c:out value="${requirement.name.content}"/></h3>
...
<div class="row">
    <div class="col-sm-8">
        <form class="form-horizontal" method="POST">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" id="type" value="<c:out value="${requirement.getClass().name}" /> "
                           readonly/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input bennu-localized-string class="form-control" id="name" name="name"
                           value="<c:out value="${requirement.name.json()}" /> " required-any/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input bennu-localized-string class="form-control" id="description" name="description"
                           value="<c:out value="${requirement.description.json()}" /> " required-any/>
                </div>
            </div>
            <div class="form-group">
    ...
    <div class="col-sm-4">
        ...
        <div class="well">
            ...
            <form method="POST"
                  action="${pageContext.request.contextPath}/application-tracking/configuration/requirement/${requirement.externalId}/delete">
